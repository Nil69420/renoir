...
use super::traits::{FieldType, ZeroCopyAccessor, ZeroCopyFormat};
...
impl OfficialFlatBufferFormat {
    ...
    pub fn register_schema(&mut self, schema: SchemaInfo) -> Result<()> {
        ...
        self.schema_registry
            .insert(schema.schema_name.clone(), schema);
        Ok(())
    }
    ...
    pub fn create_accessor_validated(
        &self,
        bytes: &[u8],
        schema: &SchemaInfo,
