...
use renoir::{
    error::Result,
    message_formats::{
        FormatType, SchemaBuilder, SchemaEvolutionManager,
        SchemaCompatibilityValidator, SchemaMigrationExecutor,
        CompatibilityLevel, SemanticVersion,
        ZeroCopyFormatRegistry,
...
mod schema_evolution_integration_tests {
    ...
    fn test_sensor_data_schema_evolution_scenario() -> Result<()> {
        ...
        assert!(migration_plan.iter().any(|step| matches!(step, MigrationStep::VersionBump { is_major: true, .. })));
    ...
    fn test_robot_pose_schema_backward_compatibility() -> Result<()> {
        ...
        let old_pose = SchemaBuilder::new("robot_pose".to_string(), FormatType::FlatBuffers)
            .version(1, 0, 0)
            .add_field(FieldDefinition::new("x".to_string(), "f64".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("y".to_string(), "f64".to_string(), true, 1, 1))
            .add_field(FieldDefinition::new("z".to_string(), "f64".to_string(), true, 1, 2))
            .build(&mut manager)?;
        ...
        let new_pose = SchemaBuilder::new("robot_pose".to_string(), FormatType::FlatBuffers)
            ...
            .add_field(FieldDefinition::new("y".to_string(), "f64".to_string(), true, 1, 1))
            .add_field(FieldDefinition::new("z".to_string(), "f64".to_string(), true, 1, 2))
            .add_field(FieldDefinition::new("qx".to_string(), "f64".to_string(), false, 2, 3))
            .add_field(FieldDefinition::new("qy".to_string(), "f64".to_string(), false, 2, 4))
            .add_field(FieldDefinition::new("qz".to_string(), "f64".to_string(), false, 2, 5))
            .add_field(FieldDefinition::new("qw".to_string(), "f64".to_string(), false, 2, 6))
            .build(&mut manager)?;

        // Test backward compatibility validation
        let validation_result = SchemaCompatibilityValidator::validate_backward_compatibility(
            &old_pose, &new_pose
        )?;

        assert!(validation_result.is_compatible);
        assert_eq!(validation_result.compatibility_level, CompatibilityLevel::FullCompatible);
    ...
    fn test_breaking_change_detection_and_migration() -> Result<()> {
        ...
        let original = SchemaBuilder::new("message".to_string(), FormatType::FlatBuffers)
            .version(1, 0, 0)
            .add_field(FieldDefinition::new("id".to_string(), "u32".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("content".to_string(), "string".to_string(), true, 1, 1))
            .build(&mut manager)?;
        ...
        let breaking_version = SchemaBuilder::new("message".to_string(), FormatType::FlatBuffers)
            ...
            .version(2, 0, 0)
            .add_field(FieldDefinition::new("message_id".to_string(), "u64".to_string(), true, 2, 0)
                .with_default("0".to_string()))
            .add_field(FieldDefinition::new("content".to_string(), "string".to_string(), true, 1, 1))
            .add_field(FieldDefinition::new("priority".to_string(), "u8".to_string(), true, 2, 2)
    ...
    fn test_format_specific_compatibility_rules() -> Result<()> {
        ...
        let fb_v1 = SchemaBuilder::new("flatbuffer_test".to_string(), FormatType::FlatBuffers)
            .version(1, 0, 0)
            .add_field(FieldDefinition::new("field_a".to_string(), "u32".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("field_b".to_string(), "string".to_string(), true, 1, 1))
            .build(&mut manager)?;

        let fb_v2 = SchemaBuilder::new("flatbuffer_test".to_string(), FormatType::FlatBuffers)
            .with_id(fb_v1.schema_id)
            .version(1, 0, 1)
            .add_field(FieldDefinition::new("field_a".to_string(), "u32".to_string(), true, 1, 1)) // Reordered
            .add_field(FieldDefinition::new("field_b".to_string(), "string".to_string(), true, 1, 0)) // Reordered
            .build(&mut manager)?;

        // Test field changes detection
        let field_changes = SchemaCompatibilityValidator::analyze_field_changes(&fb_v1, &fb_v2);
        
        assert!(field_changes.iter().any(|change| matches!(
            change, 
    ...
    fn test_migration_rollback_functionality() -> Result<()> {
        ...
        let v1_schema = SchemaBuilder::new("rollback_test".to_string(), FormatType::FlatBuffers)
            .version(1, 0, 0)
            .add_field(FieldDefinition::new("data".to_string(), "string".to_string(), true, 1, 0))
            .build(&mut manager)?;
        ...
        let v2_schema = SchemaBuilder::new("rollback_test".to_string(), FormatType::FlatBuffers)
            ...
            .version(1, 1, 0)
            .add_field(FieldDefinition::new("data".to_string(), "string".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("metadata".to_string(), "string".to_string(), false, 2, 1)
    ...
    fn test_registry_integration_with_evolution() -> Result<()> {
        ...
        let schema = SchemaBuilder::new("integration_test".to_string(), FormatType::FlatBuffers)
            .version(1, 0, 0)
            .add_field(FieldDefinition::new("test_field".to_string(), "u32".to_string(), true, 1, 0))
            .build(&mut manager)?;
        ...
        let updated_schema = SchemaBuilder::new("integration_test".to_string(), FormatType::FlatBuffers)
            .with_id(schema.schema_id)
            .version(1, 1, 0)
            .add_field(FieldDefinition::new("test_field".to_string(), "u32".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("optional_field".to_string(), "string".to_string(), false, 2, 1))
            .build(&mut manager)?;

        registry.register_evolution_schema(updated_schema)?;

        let compatibility = registry.check_schema_compatibility("integration_test", "integration_test")?;
    ...
    fn test_semantic_versioning_rules() {
        ...
        assert_eq!(v1_0_0.is_compatible_with(&v1_0_1), CompatibilityLevel::FullCompatible);
        
        // Minor version increases are backward compatible
        assert_eq!(v1_0_0.is_compatible_with(&v1_1_0), CompatibilityLevel::BackwardCompatible);
        
        // Minor version decreases are forward compatible
        assert_eq!(v1_1_0.is_compatible_with(&v1_0_0), CompatibilityLevel::ForwardCompatible);
        
        // Major version differences are breaking
        assert_eq!(v1_0_0.is_compatible_with(&v2_0_0), CompatibilityLevel::Breaking);
    }
    ...
    fn test_migration_statistics_tracking() -> Result<()> {
        ...
        let from_schema = SchemaBuilder::new("stats_test".to_string(), FormatType::FlatBuffers)
            .version(1, 0, 0)
            .add_field(FieldDefinition::new("data".to_string(), "u32".to_string(), true, 1, 0))
            .build(&mut manager)?;
        ...
        let to_schema = SchemaBuilder::new("stats_test".to_string(), FormatType::FlatBuffers)
            ...
            .version(1, 1, 0)
            .add_field(FieldDefinition::new("data".to_string(), "u32".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("extra".to_string(), "string".to_string(), false, 2, 1))
            .build(&mut manager)?;
        ...
        for i in 0..3 {
            ...
            let migration_plan = vec![
                MigrationStep::VersionBump { from_version: 1, to_version: 2, is_major: false }
            ];
    ...
    fn test_complex_real_world_scenario() -> Result<()> {
        ...
        let initial_sensor = SchemaBuilder::new("sensor_msgs/LaserScan".to_string(), FormatType::FlatBuffers)
            .version(1, 0, 0)
            .add_field(FieldDefinition::new("angle_min".to_string(), "f32".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("angle_max".to_string(), "f32".to_string(), true, 1, 1))
            .add_field(FieldDefinition::new("ranges".to_string(), "Vec<f32>".to_string(), true, 1, 2))
            .build(&mut manager)?;

        // Version 1.1.0: Add optional intensity data
        let enhanced_sensor = SchemaBuilder::new("sensor_msgs/LaserScan".to_string(), FormatType::FlatBuffers)
            .with_id(initial_sensor.schema_id)
            .version(1, 1, 0)
            .add_field(FieldDefinition::new("angle_min".to_string(), "f32".to_string(), true, 1, 0))
            .add_field(FieldDefinition::new("angle_max".to_string(), "f32".to_string(), true, 1, 1))
            .add_field(FieldDefinition::new("ranges".to_string(), "Vec<f32>".to_string(), true, 1, 2))
            .add_field(FieldDefinition::new("intensities".to_string(), "Vec<f32>".to_string(), false, 2, 3))
            .build(&mut manager)?;

        // Version 2.0.0: Breaking change - add required header field
        let modern_sensor = SchemaBuilder::new("sensor_msgs/LaserScan".to_string(), FormatType::FlatBuffers)
            .with_id(initial_sensor.schema_id)
            .version(2, 0, 0)
            .add_field(FieldDefinition::new("header".to_string(), "Header".to_string(), true, 3, 0)
                .with_default("default_header".to_string()))
            .add_field(FieldDefinition::new("angle_min".to_string(), "f32".to_string(), true, 1, 1))
            .add_field(FieldDefinition::new("angle_max".to_string(), "f32".to_string(), true, 1, 2))
            .add_field(FieldDefinition::new("ranges".to_string(), "Vec<f32>".to_string(), true, 1, 3))
            .add_field(FieldDefinition::new("intensities".to_string(), "Vec<f32>".to_string(), false, 2, 4))
            .build(&mut manager)?;
        ...
        let compat_1_0_to_1_1 = registry.check_schema_compatibility("sensor_msgs/LaserScan", "sensor_msgs/LaserScan")?;
        assert!(matches!(
            compat_1_0_to_1_1, 
